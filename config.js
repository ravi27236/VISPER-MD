...
,MONGODB: process.env.MONGODB === undefined ? 'MONGODB: process.env.MONGODB === undefined ? 'mongodb+srv://qu6054:7XGfSRE66Yp7667k@cluster0.p7y66.mongodb.net' : process.env.MONGODB' : process.env.MONGODB,
};
